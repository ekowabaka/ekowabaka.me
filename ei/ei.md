...
[[_TOC_]] Procedural content generation has been employed in several aspects of video game design. A wide variety of tools and techniques exist to help designers generate content like textures [@textmaker], cities [@cityengine], trees [@speedtree] and other natural features. In certain applications, content such as game worlds, levels and stories [@pierce] are generated in real-time to give the player a unique experience anytime they play. In this report, the focus would be entirely on procedural level generation.
...
![A screenshot from Ei](images/ei.png)
